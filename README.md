...
<a href="https://github.com/terraform-az-modules/terraform-azurerm-acr/actions/workflows/checkov.yml">
  <img src="https://github.com/terraform-az-modules/terraform-azurerm-acr/actions/workflows/checkov.yml/badge.svg" alt="checkov">
</a>
...
> ⚠️ **Important:** Avoid using the `master` branch directly, as it may include unstable changes. Always use stable [release versions](https://github.com/terraform-az-modules/terraform-azurerm-acr/releases).
...
<div align="center">
  <a href="https://github.com/terraform-az-modules/terraform-azurerm-acr/graphs/contributors" title="Contributors">
    <img src="https://contrib.rocks/image?repo=terraform-az-modules/terraform-azurerm-acr" />
  </a>
</div>
